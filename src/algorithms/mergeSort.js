...
export const mergeSortKey = createKey('Call Merge Sort', null, 'Overwrite from auxillary array');
...
export const mergeSortDesc = {
  ...
  description: (
    <div>
      ...
      <ol>
        <li>
          Divide the unsorted list into <em>n</em> sublists, each containing one element(a list of one element is considered sorted)
        </li>
        <li>
